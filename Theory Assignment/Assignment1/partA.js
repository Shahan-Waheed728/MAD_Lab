...
//using trim fucntion
let tr1= fact.trim();
let tr2 = fact.trimStart();
let tr3 = fact.trimEnd();
console.log("After Trim:",tr1);
console.log("After Trim from start:",tr2)
console.log("After Trim at end",tr3)
console.log("Before trim:",fact);
//padding 
//pad start with ---
let pd1 = fact.padStart(35,"*");
let pd2 = fact.padEnd(40,"-");
console.log("Padding at start:",pd1);
console.log("Padding at end:",pd2);

//repeating a sentence 2 times
let rp = sentence.repeat(2);
console.log(rp);
//repeating fact 3 times
let rp1 = fact.repeat(3);
console.log(rp1);

//replacing value
let rp2 = sentence.replace("dog","cat");
console.log(rp2);
let rp3 = fact.replace("EngLish","english");
console.log(rp3);
let rp4 = sentence.replaceAll("The","the");
console.log(rp4);
//splitting sentence to an array
let sp = sentence.split(" ");//splitting using comma
console.log(sp);